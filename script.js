...
function handleAmbientMixer(slider, audioEl, readoutId) {
    ...
    if (audioEl.id === 'fire-audio') {
        slider.addEventListener('input', (e) => {
            ...
            // 💡 FIX 1: Modern browsers (like Chrome/Safari) often boot up the AudioContext 
            // in a "suspended" state. We must resume it when the user interacts.
            ...
            if (val == 0) {
                ...
                if (audioEl.paused) audioEl.play().catch(o => {});
            }
        });
    } else {
        slider.addEventListener('input', (e) => {
